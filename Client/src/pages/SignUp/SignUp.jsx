              ...
              <div className="rounded-t mb-0 px-6 py-6">
                ...
                <div className="btn-wrapper text-center flex flex-col mt-4 justify-center">
                  ...
                  <button
                    ...
                    className="bg-white active:bg-gray-100 text-gray-800 font-semibold px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 uppercase shadow hover:shadow-md inline-flex items-center font-bold text-xs justify-center   h-9"
                    type="button"
                    style={{ transition: "all .15s ease" }}
                  >
                    <span>
